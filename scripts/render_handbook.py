...
def render_html(profile, places, out):
    ...
    (out/"index.html").write_text("<!doctype html><html lang='zh-CN'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>"+esc(title)+"旅行手册</title><style>"+css+"</style></head><body><main>"+body+"</main></body></html>", encoding="utf-8")
